type HughesLogotypeProps = { className?: string; viewBox?: string; preserveAspectRatio?: string };

export function HughesLogotype({ className = "", viewBox = "90 30 650 320", preserveAspectRatio = "xMidYMid meet" }: HughesLogotypeProps) {
  return (
    <svg className={className} viewBox={viewBox} preserveAspectRatio={preserveAspectRatio} role="img" aria-label="Hughesss">
